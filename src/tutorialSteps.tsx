const tutorialSteps = [
	{
		description: (
			<span>
				This is a Chrome Extension, that logs you into Cis and Moodle
				automatically
			</span>
		),
	...
	},
	{
		description: (
			<span>
				Place the folder <i>&nbsp;NAKExtension&nbsp;</i> somewhere (don't move
	...
	},
	{
		description: (
			<span>
				Type <i>&nbsp;chrome://extensions&nbsp;</i> in the address bar and press
				enter
			</span>
		),
	...
	},
	{
		description: (
			<span>
				Click on <i>&nbsp;Load unpacked&nbsp;</i> and select your{" "}
